...
import ru.javaonline.basejava.model.SectionType;
import ru.javaonline.basejava.model.TextListSection;
...
public class MainSql {
    ...
    public static void main(String[] args) {
        ...
        String listPosition = ((TextListSection) resume.getBody().get(SectionType.ACHIEVEMENT)).getListPosition()
                .stream().reduce("", (acc, s) -> String.format("%s%s\n", acc, s));
        System.out.println(listPosition);
        String[] arr = listPosition.split("\n");
        for (String s : arr) {
